...
class Personagem(pygame.sprite.Sprite):
    ...
    def update(self, movimento, movimentov, plataformas, chaos, papels):
...
def jogo1():
    ...
    # PARTE3 (DIAGONAL DECRESCENTE)
    l7 = [(x, SCREEN_HEIGHT - (1200 - (x - 200) // 2)) for x in range(1200, 1600, 100)]  # TOP
    l10 = [(x, SCREEN_HEIGHT - (1500 - (x - 200) // 2)) for x in range(1800, 2600, 100)]
    l11 = [(x, SCREEN_HEIGHT - (1200 - (x - 200) // 2)) for x in range(1900, 2200, 100)]

    # VERTICAL
    l8 = [(1500, y) for y in range(SCREEN_HEIGHT - 250, SCREEN_HEIGHT - 550, -100)]
    l9 = [(1750, y) for y in range(SCREEN_HEIGHT - 250, SCREEN_HEIGHT - 550, -100)]
    ...
    posicoes_papel = [
        ...
        (1400, SCREEN_HEIGHT - 700)

    ]
    for x, y in posicoes_papel:
        papels.add(Papel(x, y))
    ...
    while rodando:
        ...
        personagem.update(movimento, movimentov, plataformas, chaos, papels)
        ...
        for papel in papels:
            papel.rect.x -= movimento_horizontal
