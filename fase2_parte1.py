...
pygame.display.set_caption("fase2_parte1")
...
cogumelo_img = pygame.image.load('cogumelo.png').convert_alpha()
...
aviso_img = pygame.image.load('aviso4.png').convert_alpha()
...
class Personagem(pygame.sprite.Sprite):
    ...
    def update(self, movimento, plataformas, chaos, inimigos, placas):
        ...
        if self.rect.x >= 900:
            ...
            import carrega_vidas
            import fase2_parte2
            fase2_parte2.jogo(carrega_vidas.vidas_personagem)
...
def jogo():
    ...
    # COGU
    posicoes_inimigos = [(x, SCREEN_HEIGHT - 170) for x in range(800, 2000, 100)]
    for x, y in posicoes_inimigos:
        inimigos.add(Inimigo(x, y))
    ...
    while rodando:
        ...
        personagem.update(movimento, plataformas, chaos, inimigos, placas)
