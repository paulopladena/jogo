...
pygame.display.set_caption("jogo_fase1_parte2")
...
aviso_img = pygame.image.load('aviso2.png').convert_alpha()
...
def jogo():
    ...
    #PEDRA
    posicoes_obstaculos = [
        (1400, SCREEN_HEIGHT - 260),
        (1500, SCREEN_HEIGHT - 260),
        (2400, SCREEN_HEIGHT - 100)
    ]
    ...
    #CHAO
    posicoes_chaos = [
        (-50, SCREEN_HEIGHT - 200),  # Obstáculo 2
        (1100, SCREEN_HEIGHT - 200)  # Obstáculo 3
    ]
    ...
    while rodando:
        ...
        personagem.update(movimento, plataformas, chaos, placas, portals)
