...
aviso_img = pygame.image.load('aviso8.png').convert_alpha()
...
def fase1():
    global personagem, chaos, nave, placa, todos_sprites
    ...
    placa = Placa(150, SCREEN_HEIGHT - 120)

    todos_sprites = pygame.sprite.Group()
    todos_sprites.add(nave, chao1, chao2, personagem, placa)  # Adiciona a nave e o personagem ao início
